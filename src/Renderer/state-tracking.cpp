...
namespace GuGu{
    namespace nvrhi{
        ...
        void CommandListResourceStateTracker::requireBufferState(BufferStateExtension *buffer,
        ...
        BufferState *
        CommandListResourceStateTracker::getBufferStateTracking(BufferStateExtension *buffer,
                                                                bool allowCreate) {
        ...
        void CommandListResourceStateTracker::requireTextureState(TextureStateExtension *texture,
        ...
        TextureState *
        CommandListResourceStateTracker::getTextureStateTracking(TextureStateExtension *texture,
                                                                 bool allowCreate) {
