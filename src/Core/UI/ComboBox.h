...
namespace GuGu {
	...
	public:
		struct BuilderArguments : public Arguments<ComboRow<OptionType>>
		{
			BuilderArguments()
				//: mContent()
				: mStyle(CoreStyle::getStyleSet()->template getStyle<TableRowStyle>("comboBox.Row"))
				, mpadding(Padding(0))
			{
	...
	public:
		...
		{
			BuilderArguments()
				: mcomboBoxStyle(CoreStyle::getStyleSet()->template getStyle<ComboBoxStyle>("comboBox"))
				, mItemStyle(CoreStyle::getStyleSet()->template getStyle<TableRowStyle>("comboBox.Row"))
